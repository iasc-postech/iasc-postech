...
# data load
with open('./sample/scenegraph.json', 'r') as jsonfile:
    json_data = json.load(jsonfile)
img = cv2.imread('./sample/input.jpg')
img_mask = cv2.imread('./sample/mask.jpg')

data = json.dumps(
    {
        'image_contents': imageToString(img),
        'mask_contents': imageToString(img_mask),            
...
img = stringToImage(imagestring['image_contents'])
cv2.imwrite('./sample/result.jpg', img)
